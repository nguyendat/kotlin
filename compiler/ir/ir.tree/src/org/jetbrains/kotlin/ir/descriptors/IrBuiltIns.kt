...
class IrBuiltIns(val builtIns: KotlinBuiltIns) {
    ...
    val floatN = builtIns.floatType.makeNullableAsSpecified(true)
    val double = builtIns.doubleType
    val doubleN = builtIns.doubleType.makeNullableAsSpecified(true)
    ...
    val eqeqIeee754FloatFun = defineOperator("EQEQ_IEEE_754", bool, listOf(floatN, floatN))
    val eqeqIeee754DoubleFun = defineOperator("EQEQ_IEEE_754", bool, listOf(doubleN, doubleN))
    ...
    val compareToIeee754FloatFun = defineOperator("compareTo_IEEE_754", int, listOf(float, float))
    val compareToIeee754DoubleFun = defineOperator("compareTo_IEEE_754", int, listOf(double, double))
    ...
    val eqeqIeee754Float = eqeqIeee754FloatFun.descriptor
    val eqeqIeee754Double = eqeqIeee754DoubleFun.descriptor
    val lt0 = lt0Fun.descriptor
    val lteq0 = lteq0Fun.descriptor
    val gt0 = gt0Fun.descriptor
    val gteq0 = gteq0Fun.descriptor
    val compareToIeee754Float = compareToIeee754FloatFun.descriptor
    val compareToIeee754Double = compareToIeee754DoubleFun.descriptor
    ...
    val eqeqIeee754FloatSymbol = eqeqIeee754FloatFun.symbol
    val eqeqIeee754DoubleSymbol = eqeqIeee754DoubleFun.symbol
    val lt0Symbol = lt0Fun.symbol
    val lteq0Symbol = lteq0Fun.symbol
    val gt0Symbol = gt0Fun.symbol
    val gteq0Symbol = gteq0Fun.symbol
    val compareToIeee754FloatSymbol = compareToIeee754FloatFun.symbol
    val compareToIeee754DoubleSymbol = compareToIeee754DoubleFun.symbol
